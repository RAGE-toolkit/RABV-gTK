...
'''
Change --base_dir for update otherwise keep it blank
	python scripts/GenBankParser.py --input_dir tmp/Update/GenBank-XML/ --base_dir tmp/Update --ref_list generic/rabv/ref_list_based_on_blast.txt
'''
class GenBankParser:
	def __init__(
		self,
